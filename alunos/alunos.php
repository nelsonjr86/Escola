...
// Paginação
	...
	$sql = 'SELECT * FROM alunos WHERE nome_completo LIKE :keyword';// OR email LIKE :keyword OR data_nasc LIKE :keyword OR cpf LIKE :keyword ORDER BY id DESC ';
...
<div class="row">
    <div class="col-md-3">
    <a href="add.php" class="btn btn-primary">Novo alunos</a>
    </div>
