...
?>
            ...
            <input name="enviar" class="btn btn-warning" type="button" onclick="location='cursos.php'" value="Voltar">
            </form>
        </div>
    <div>
</div>
...
$id = $_POST['id'];
    ...
    if( $sth->execute()){
        print "<script>alert('Registro excluído com sucesso!');location='cursos.php';</script>";
    }else{
