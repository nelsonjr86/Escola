...
// Paginação
	...
	$sql = 'SELECT * FROM cursos WHERE nome_curso LIKE :keyword';// OR email LIKE :keyword OR data_nasc LIKE :keyword OR cpf LIKE :keyword ORDER BY id DESC ';
...
<div class="row">
    <div class="col-md-3">
    <a href="cursos/add.php" class="btn btn-primary">Novo cursos</a>
    </div>
